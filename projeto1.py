...
Inicialmente o usuário deve fornecer as coordenadas cartesianas da posição inicial do objeto, em condições normais a coordenada x pode ser positiva ou negativa e a coordenada z deve ser negativa, assim o programa converte as coordenadas para o sistema polar e calcula as acelerações a cada instante com de 0,001 segundos com os dados da coordenada radial e angular.
...
t = 0                                                                                     # tempo inicial (s)
tf = float(input('\nDigite o tempo transcorrido no movimento: '))                         # tempo final (s)
